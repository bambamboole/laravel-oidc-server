...
return [
    ...
    | `oidc:rotate-keys --if-missing`.
    |
    */
    'keys' => [
        // Holds the signing keypair. The shipped store keeps it in oidc_signing_keys
        // with the private key encrypted at rest; bind your own SigningKeyStore for
        // a KMS or vault.
