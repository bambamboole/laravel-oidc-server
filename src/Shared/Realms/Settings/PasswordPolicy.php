...
/**
 * What a new password must satisfy and how long one stays valid. Composition
 * rules map onto Laravel's Password rule; history and rotation are enforced
 * by the Credentials domain against its own password history.
 */
